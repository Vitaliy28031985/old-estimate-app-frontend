...
import {useAddLowProjectPriceMutation} from "../../../redux/lowProjectPrice/lowProjectPriceApi";
import {projectsApi} from "../../../redux/projectSlice/projectSlice";
import Mic from "../../Icons/Mic/Mic";
import s from "./AddLowProjectPrice.module.scss";

function AddLowProjectPrice({onModal}) {
    const {id} = useParams();
    ...
    const [ addLowProjectPrice] = useAddLowProjectPriceMutation();
    ...
    const handleSubmit = async e => {
        ...
        if (data?.lowPrices.find(data => data.title === title)) {
        ...
        try {
            ...
            const newPriceData = {id, newPrice: {title, price: newPrice}}
                const add = await addLowProjectPrice(newPriceData);
...
export default AddLowProjectPrice;