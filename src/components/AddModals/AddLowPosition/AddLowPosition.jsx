...
function AddLowPosition({onModal}) {
    const { id } = useParams();
    ...
    const filteredPrices = project?.lowPrices?.filter(item =>
 ...
 const handleSubmit = async e => {
   ...
   const currentPrice = await project?.lowPrices?.filter(item => item.title === title);
